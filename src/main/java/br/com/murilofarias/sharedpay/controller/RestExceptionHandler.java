...
import br.com.murilofarias.sharedpay.controller.dto.error.ApiError;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleDomainException(DomainException ex, WebRequest request) {
        ApiError apiError = new ApiError(
                ex.getStatus(), ex.getLocalizedMessage(), ex.getErrors() );
        return new ResponseEntity<Object>(
                apiError, new HttpHeaders(), apiError.getStatus());
    }
    ...
    public ResponseEntity<Object> handleResourceNotFoundException(ResourceNotFoundException ex, WebRequest request) {
        ApiError apiError = new ApiError(
                ex.getStatus(), ex.getLocalizedMessage() );
        return new ResponseEntity<Object>(
                apiError, new HttpHeaders(), apiError.getStatus());
    }

    @ExceptionHandler({ PaymentServiceException.class })
    public ResponseEntity<Object> handleResourceNotFoundException(PaymentServiceException ex, WebRequest request) {
        ApiError apiError = new ApiError(
                ex.getStatus(), ex.getLocalizedMessage() );
        return new ResponseEntity<Object>(
                apiError, new HttpHeaders(), apiError.getStatus());
